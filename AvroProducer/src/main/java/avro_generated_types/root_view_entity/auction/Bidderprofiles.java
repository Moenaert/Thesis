...
public class Bidderprofiles extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private static final BinaryMessageEncoder<Bidderprofiles> ENCODER =
      new BinaryMessageEncoder<Bidderprofiles>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<Bidderprofiles> DECODER =
      new BinaryMessageDecoder<Bidderprofiles>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageDecoder instance used by this class.
   */
  public static BinaryMessageDecoder<Bidderprofiles> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<Bidderprofiles> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<Bidderprofiles>(MODEL$, SCHEMA$, resolver);
  }

  /** Serializes this Bidderprofiles to a ByteBuffer. */
  public java.nio.ByteBuffer toByteBuffer() throws java.io.IOException {
    return ENCODER.encode(this);
  }

  /** Deserializes a Bidderprofiles from a ByteBuffer. */
  public static Bidderprofiles fromByteBuffer(
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<Bidderprofiles>
    WRITER$ = (org.apache.avro.io.DatumWriter<Bidderprofiles>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<Bidderprofiles>
    READER$ = (org.apache.avro.io.DatumReader<Bidderprofiles>)MODEL$.createDatumReader(SCHEMA$);
