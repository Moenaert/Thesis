...
public class Root_account_entity extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private static final BinaryMessageEncoder<Root_account_entity> ENCODER =
      new BinaryMessageEncoder<Root_account_entity>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<Root_account_entity> DECODER =
      new BinaryMessageDecoder<Root_account_entity>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageDecoder instance used by this class.
   */
  public static BinaryMessageDecoder<Root_account_entity> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<Root_account_entity> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<Root_account_entity>(MODEL$, SCHEMA$, resolver);
  }

  /** Serializes this Root_account_entity to a ByteBuffer. */
  public java.nio.ByteBuffer toByteBuffer() throws java.io.IOException {
    return ENCODER.encode(this);
  }

  /** Deserializes a Root_account_entity from a ByteBuffer. */
  public static Root_account_entity fromByteBuffer(
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<Root_account_entity>
    WRITER$ = (org.apache.avro.io.DatumWriter<Root_account_entity>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<Root_account_entity>
    READER$ = (org.apache.avro.io.DatumReader<Root_account_entity>)MODEL$.createDatumReader(SCHEMA$);
