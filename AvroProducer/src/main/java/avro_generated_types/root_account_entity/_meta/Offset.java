 ...
 */
package avro_generated_types.root_account_entity._meta;
...
public class Offset extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 3189824912328053343L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Offset\",\"namespace\":\"avro_generated_types.root_account_entity._meta\",\"fields\":[{\"name\":\"topic\",\"type\":\"string\"},{\"name\":\"partition\",\"type\":\"long\"},{\"name\":\"offset\",\"type\":\"long\"}]}");
  ...
  @Deprecated public long partition;
   ...
   */
  public static avro_generated_types.root_account_entity._meta.Offset.Builder newBuilder() {
    return new avro_generated_types.root_account_entity._meta.Offset.Builder();
  }
   ...
   * @return A new Offset RecordBuilder
   */
  public static avro_generated_types.root_account_entity._meta.Offset.Builder newBuilder(avro_generated_types.root_account_entity._meta.Offset.Builder other) {
    return new avro_generated_types.root_account_entity._meta.Offset.Builder(other);
  }
   ...
   * @return A new Offset RecordBuilder
   */
  public static avro_generated_types.root_account_entity._meta.Offset.Builder newBuilder(avro_generated_types.root_account_entity._meta.Offset other) {
    return new avro_generated_types.root_account_entity._meta.Offset.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Offset>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(avro_generated_types.root_account_entity._meta.Offset.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(avro_generated_types.root_account_entity._meta.Offset other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.topic)) {
        this.topic = data().deepCopy(fields()[0].schema(), other.topic);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public avro_generated_types.root_account_entity._meta.Offset.Builder setTopic(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro_generated_types.root_account_entity._meta.Offset.Builder clearTopic() {
      topic = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public avro_generated_types.root_account_entity._meta.Offset.Builder setPartition(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro_generated_types.root_account_entity._meta.Offset.Builder clearPartition() {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro_generated_types.root_account_entity._meta.Offset.Builder setOffset(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro_generated_types.root_account_entity._meta.Offset.Builder clearOffset() {
